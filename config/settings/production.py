...
ALLOWED_HOSTS = env.list("DJANGO_ALLOWED_HOSTS", default=["bitbank.com"])
...
DEFAULT_FROM_EMAIL = env(
    "DJANGO_DEFAULT_FROM_EMAIL", default="bitbank-server <noreply@bitbank.com>"
)
